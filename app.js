...
expenses.
      ...
      I understand that Layton is not responsible for any damage to the vehicle resulting 
from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.

      I understand and agree that Layton may provide my contact information to a third-party
organization that may contact me for the sole purpose of conducting a customer satisfaction survey.

      LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Layton provides a 
...
as I own the vehicle. During the limited warranty period, Layton will repair or replace any defects 
caused by Layton or its agents. All warranty repairs must be performed at one of Layton 
facilities; any repairs or alterations to the vehicle performed non-Layton facility in any manner 
whatsoever shall automatically void this limited warranty. This limited warranty shall not apply to 
repairs necessitated by any cause beyond the reasonable control of Layton, including any defects, 
...
party other than Layton, abuse, misuse, neglect, acts of God, or environmental damage. 
...
PARTICULAR PURPOSE.
      ...
      LIMITATION OF LIABILITY. In no event shall Layton be liable for consequential, special, or 
indirect damages of any nature, and Layton maximum liability shall be no greater than the amount 
actually paid to, and received by, Layton for the services performed on the vehicle.
...
Layton. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and 
...
writing and signed by both you and an authorized manager of Layton.

      I authorize any and all supplements payable direct to Layton CarCare.  I authorize Layton Downtown
